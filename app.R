...
locations = st_read("data/geo/Locations.shp", crs = 4326)
lakes = st_read("data/geo/Lakes.shp", crs = 4326)
conts = st_read("data/geo/Continents.shp", crs = 4326)
land = st_read("data/geo/Land.shp", crs = 4326)
wall = st_read("data/geo/Wall.shp", crs = 4326)
islands = st_read("data/geo/Islands.shp", crs = 4326)
kingdoms = st_read("data/geo/Political.shp", crs = 4326)
landscapes = st_read("data/geo/Landscape.shp", crs = 4326)
roads = st_read("data/geo/Roads.shp", crs = 4326)
rivers = st_read("data/geo/Rivers.shp", crs = 4326)
scenes_locations = st_read("data/geo/ScenesLocations.shp", crs = 4326)
